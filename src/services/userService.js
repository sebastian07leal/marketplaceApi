...
class UserService {
  ...
  async createNewUser(data) {
    ...
    await this._client.query('INSERT INTO users_roles (user_id, role_id) VALUES ($1, $2);', [
      customId,
      role,
    ]);
  ...
  async removeUser(id) {
    ...
    await this._client.query('DELETE FROM users_roles WHERE user_id = $1 RETURNING user_id;', [
      id
    ]);

    await this._client.query('DELETE FROM users WHERE id = $1', [
      id
    ]);
