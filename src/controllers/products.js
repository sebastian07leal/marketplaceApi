...
const createProduct = async (req, res) => {
    try {
        ...
        const response =
            await ProductService.getInstance().createNewProduct(body);
...
const putProductById = async (req, res) => {
    try {
        ...
        const response = await ProductService.getInstance().updateProductById(
            id,
            body,
        );
...
const deleteProduct = async (req, res) => {
    try {
        ...
        const response =
            await ProductService.getInstance().deleteProductById(id);
